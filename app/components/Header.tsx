...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: t("handmade"), dropdownKey: "handmade", hasDropdown: false, href: "/handmade", icon: <img src="/images/whatsapp-icon.jpeg" alt="handmade" className="w-4 h-4 rounded-sm object-contain" /> }, 
