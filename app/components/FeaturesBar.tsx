  ...
  const features = [
    {
      ...
      title: t("23_million_titles"),
      description: t("in_150_languages"),
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t("great_prices"),
      description: t("always_up_to_date"),
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t("libroamanto_club"),
      description: t("full_of_gifts"),
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t("2_million_customers"),
      description: t("served_every_year"),
    },
  ];
  return (
